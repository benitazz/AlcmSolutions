intellisense.annotate(jQuery, {
  ...
  'holdReady': function() {
    /// <signature>
    ///   <summary>Holds or releases the execution of jQuery's ready eventType.</summary>
...
intellisense.annotate(jQuery.Event.prototype, {
  'currentTarget': function() {
    /// <summary>The current DOM element within the eventType bubbling phase.</summary>
    /// <returns type="Element" />
  },
  'data': function() {
    /// <summary>An optional object of data passed to an eventType method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
  'delegateTarget': function() {
    /// <summary>The element where the currently-called jQuery eventType handler was attached.</summary>
    /// <returns type="Element" />
  },
  'isDefaultPrevented': function() {
    /// <summary>Returns whether eventType.preventDefault() was ever called on this eventType object.</summary>
    /// <returns type="Boolean" />
  },
  'isImmediatePropagationStopped': function() {
    /// <summary>Returns whether eventType.stopImmediatePropagation() was ever called on this eventType object.</summary>
    /// <returns type="Boolean" />
  },
  'isPropagationStopped': function() {
    /// <summary>Returns whether eventType.stopPropagation() was ever called on this eventType object.</summary>
    /// <returns type="Boolean" />
  },
  'metaKey': function() {
    /// <summary>Indicates whether the META key was pressed when the eventType fired.</summary>
    /// <returns type="Boolean" />
  },
  'namespace': function() {
    /// <summary>The namespace specified when the eventType was triggered.</summary>
    /// <returns type="String" />
  },
  'pageX': function() {
  ...
  'preventDefault': function() {
    /// <summary>If this method is called, the default action of the eventType will not be triggered.</summary>
  },
  'relatedTarget': function() {
    /// <summary>The other DOM element involved in the eventType, if any.</summary>
    /// <returns type="Element" />
  },
  'result': function() {
    /// <summary>The last value returned by an eventType handler that was triggered by this eventType, unless the value was undefined.</summary>
    /// <returns type="Object" />
  },
  'stopImmediatePropagation': function() {
    /// <summary>Keeps the rest of the handlers from being executed and prevents the eventType from bubbling up the DOM tree.</summary>
  },
  'stopPropagation': function() {
    /// <summary>Prevents the eventType from bubbling up the DOM tree, preventing any parent handlers from being notified of the eventType.</summary>
  },
  'target': function() {
    /// <summary>The DOM element that initiated the eventType.</summary>
    /// <returns type="Element" />
  },
  'timeStamp': function() {
    /// <summary>The difference in milliseconds between the time the browser created the eventType and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
    /// <summary>Describes the nature of the eventType.</summary>
    /// <returns type="String" />
  },
  'which': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxComplete': function() {
    ...
    ///   <param name="handler(eventType, XMLHttpRequest, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxError': function() {
    ...
    ///   <param name="handler(eventType, jqXHR, ajaxSettings, thrownError)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxSend': function() {
    ...
    ///   <param name="handler(eventType, jqXHR, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxStart': function() {
  ...
  'bind': function() {
    /// <signature>
    ///   <summary>Attach a handler to an eventType for the elements.</summary>
    ///   <param name="eventType" type="String">A string containing one or more DOM eventType types, such as "click" or "submit," or custom eventType names.</param>
    ///   <param name="eventData" type="Object">An object containing data that will be passed to the eventType handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an eventType for the elements.</summary>
    ///   <param name="eventType" type="String">A string containing one or more DOM eventType types, such as "click" or "submit," or custom eventType names.</param>
    ///   <param name="eventData" type="Object">An object containing data that will be passed to the eventType handler.</param>
    ///   <param name="preventBubble" type="Boolean">Setting the third argument to false will attach a function that prevents the default action from occurring and stops the eventType from bubbling. The default is true.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an eventType for the elements.</summary>
    ///   <param name="events" type="Object">An object containing one or more DOM eventType types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'blur': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "blur" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'change': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "change" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'click': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "click" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether eventType handlers should be copied along with the elements. As of jQuery 1.4, element data will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether eventType handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether eventType handlers and data for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'dblclick': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "dblclick" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'delegate': function() {
    ...
    ///   <param name="selector" type="String">A selector to filter the elements that trigger the eventType.</param>
    ///   <param name="eventType" type="String">A string containing one or more space-separated JavaScript eventType types, such as "click" or "keydown," or custom eventType names.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ...
    ///   <summary>Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector to filter the elements that trigger the eventType.</param>
    ///   <param name="events" type="PlainObject">A plain object of one or more eventType types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dequeue': function() {
  ...
  'die': function() {
    /// <signature>
    ///   <summary>Remove eventType handlers previously attached using .live() from the elements.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript eventType type, such as click or keydown.</param>
    ///   <param name="handler" type="String">The function that is no longer to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove eventType handlers previously attached using .live() from the elements.</summary>
    ///   <param name="events" type="PlainObject">A plain object of one or more eventType types, such as click or keydown and their corresponding functions that are no longer to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'disabled': function() {
  ...
  'error': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "error" JavaScript eventType.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an eventType handler to the "error" JavaScript eventType.</summary>
  ...
  'focus': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "focus" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'focusin': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "focusin" eventType.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'focusout': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "focusout" JavaScript eventType.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'keydown': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "keydown" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an eventType handler to the "keydown" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="eventData" type="PlainObject">An object containing data that will be passed to the eventType handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'keypress': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "keypress" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'keyup': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "keyup" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'live': function() {
    /// <signature>
    ///   <summary>Attach an eventType handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript eventType type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated eventType types or custom eventType names.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an eventType handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript eventType type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated eventType types or custom eventType names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the eventType handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an eventType handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="PlainObject">A plain object of one or more JavaScript eventType types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'load': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "load" JavaScript eventType.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mousedown': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "mousedown" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseenter': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to be fired when the mouse enters an element, or trigger that handler on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseleave': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to be fired when the mouse leaves an element, or trigger that handler on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mousemove': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "mousemove" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseout': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "mouseout" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseover': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "mouseover" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseup': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "mouseup" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'off': function() {
    /// <signature>
    ///   <summary>Remove an eventType handler.</summary>
    ///   <param name="events" type="String">One or more space-separated eventType types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching eventType handlers.</param>
    ///   <param name="handler(eventObject)" type="Function">A handler function previously attached for the eventType(s), or the special value false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove an eventType handler.</summary>
    ///   <param name="events" type="PlainObject">An object where the string keys represent one or more space-separated eventType types and optional namespaces, and the values represent handler functions previously attached for the eventType(s).</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching eventType handlers.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'on': function() {
    /// <signature>
    ///   <summary>Attach an eventType handler function for one or more events to the selected elements.</summary>
    ///   <param name="events" type="String">One or more space-separated eventType types and optional namespaces, such as "click" or "keydown.myPlugin".</param>
    ///   <param name="selector" type="String">A selector string to filter the descendants of the selected elements that trigger the eventType. If the selector is null or omitted, the eventType is always triggered when it reaches the selected element.</param>
    ///   <param name="data" type="Anything">Data to be passed to the handler in eventType.data when an eventType is triggered.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the eventType is triggered. The value false is also allowed as a shorthand for a function that simply does return false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an eventType handler function for one or more events to the selected elements.</summary>
    ///   <param name="events" type="PlainObject">An object in which the string keys represent one or more space-separated eventType types and optional namespaces, and the values represent a handler function to be called for the eventType(s).</param>
    ...
    ///   <param name="data" type="Anything">Data to be passed to the handler in eventType.data when an eventType occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
    /// <signature>
    ///   <summary>Attach a handler to an eventType for the elements. The handler is executed at most once per element.</summary>
    ///   <param name="events" type="String">A string containing one or more JavaScript eventType types, such as "click" or "submit," or custom eventType names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the eventType handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'resize': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "resize" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'scroll': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "scroll" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'select': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "select" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'submit': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "submit" JavaScript eventType, or trigger that eventType on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'trigger': function() {
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given eventType type.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript eventType type, such as click or submit.</param>
    ///   <param name="extraParameters" type="">Additional parameters to pass along to the eventType handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given eventType type.</summary>
    ///   <param name="eventType" type="Event">A jQuery.Event object.</param>
    ///   <param name="extraParameters" type="">Additional parameters to pass along to the eventType handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'triggerHandler': function() {
    /// <signature>
    ///   <summary>Execute all handlers attached to an element for an eventType.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript eventType type, such as click or submit.</param>
    ///   <param name="extraParameters" type="Array">An array of additional parameters to pass along to the eventType handler.</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'unbind': function() {
    /// <signature>
    ///   <summary>Remove a previously-attached eventType handler from the elements.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript eventType type, such as click or submit.</param>
    ...
    /// <signature>
    ///   <summary>Remove a previously-attached eventType handler from the elements.</summary>
    ///   <param name="eventType" type="Object">A JavaScript eventType object as passed to an eventType handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'undelegate': function() {
    /// <signature>
    ///   <summary>Remove a handler from the eventType for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector which will be used to filter the eventType results.</param>
    ///   <param name="eventType" type="String">A string containing a JavaScript eventType type, such as "click" or "keydown"</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ...
    ///   <summary>Remove a handler from the eventType for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector which will be used to filter the eventType results.</param>
    ///   <param name="events" type="PlainObject">An object of one or more eventType types and previously bound functions to unbind from them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a handler from the eventType for all elements which match the current selector, based upon a specific set of root elements.</summary>
  ...
  'unload': function() {
    /// <signature>
    ///   <summary>Bind an eventType handler to the "unload" JavaScript eventType.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an eventType handler to the "unload" JavaScript eventType.</summary>
    ///   <param name="eventData" type="Object">A plain object of data that will be passed to the eventType handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the eventType is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
