...
using Article = DurandalAuth.Domain.Models.Article;
using Tag = DurandalAuth.Domain.Models.Tag;
...
{
    /// <summary>
    /// The breeze validator.
    /// </summary>
    public class BreezeValidator : IBreezeValidator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BreezeValidator"/> class.
        /// </summary>
        ...
        /// </returns>
        /// <exception cref="EntityErrorsException">
        /// </exception>
