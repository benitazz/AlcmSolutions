...
namespace DurandalAuth.Domain.Models
{
    ...
    {
        public decimal annual_operating_costs { get; set; }
        public decimal btu_consumption { get; set; }
        public string city { get; set; }
        public short condition_index { get; set; }
        public string congressional_district { get; set; }
        public int count_emp_contractor { get; set; }
        public int count_emp_fed { get; set; }
        public int count_emp_fed_telework { get; set; }
        ...
        public decimal disposition_value { get; set; }
        ...
        public short historical_status { get; set; }
        ...
        public short mission_dependency { get; set; }
        ...
        public decimal size_gross_area { get; set; }
        public decimal size_rural_acres { get; set; }
        public decimal size_structural_unit { get; set; }
        public short size_unit_of_measure { get; set; }
        public decimal size_urban_acres { get; set; }
        public string state { get; set; }
        public string status_indicator { get; set; }
        public string street_address { get; set; }
        public string sub_installation_identifier { get; set; }
        public short sustainability { get; set; }
        public System.DateTime time_last_update { get; set; }
