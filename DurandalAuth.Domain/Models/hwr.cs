...
{
    public partial class hwr
    {
        public hwr()
        {
            this.hwr_other = new List<hwr_other>();
            this.hwrcfs = new List<hwrcf>();
            this.hwrpts = new List<hwrpt>();
            this.hwrtls = new List<hwrtl>();
            this.hwrtrs = new List<hwrtr>();
            this.hwrtts = new List<hwrtt>();
        }
        ...
        public virtual ICollection<hwr_other> hwr_other { get; set; }
        public virtual ICollection<hwrcf> hwrcfs { get; set; }
        public virtual ICollection<hwrpt> hwrpts { get; set; }
        public virtual ICollection<hwrtl> hwrtls { get; set; }
        public virtual ICollection<hwrtr> hwrtrs { get; set; }
        public virtual ICollection<hwrtt> hwrtts { get; set; }
    }
}
