...
namespace DurandalAuth.Domain.Models
{
    public partial class dp
    {
        ...
        public string approving_mgr { get; set; }
        ...
        public decimal area_rm_personnel { get; set; }
        public decimal area_second_circ { get; set; }
        public decimal cost { get; set; }
        public int count_em { get; set; }
        public decimal em_area_chargable { get; set; }
        public decimal em_area_comn { get; set; }
        public decimal em_area_comn_rm { get; set; }
        public decimal em_area_comn_serv { get; set; }
        public decimal em_area_rm { get; set; }
        public decimal em_cost { get; set; }
