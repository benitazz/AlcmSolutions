...
{
    public class gb_fp_airc_dataMap : EntityTypeConfiguration<gb_fp_airc_data>
    {
        public gb_fp_airc_dataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.version_type, t.version_name, t.aircraft_type });
            ...
            this.ToTable("gb_fp_airc_data", "afm");
            this.Property(t => t.avg_fuel).HasColumnName("avg_fuel");
            this.Property(t => t.avg_fuel_entry).HasColumnName("avg_fuel_entry");
