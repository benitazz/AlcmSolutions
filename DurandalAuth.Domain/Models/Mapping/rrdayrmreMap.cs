...
{
    public class rrdayrmreMap : EntityTypeConfiguration<rrdayrmre>
    {
        public rrdayrmreMap()
        {
            // Primary Key
            this.HasKey(t => new { t.bl_id, t.date_start, t.time_start, t.time_end, t.fl_id, t.rm_id, t.rm_arrange_type_id, t.config_id });
