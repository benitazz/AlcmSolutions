...
{
    public class cost_tran_schedMap : EntityTypeConfiguration<cost_tran_sched>
    {
        public cost_tran_schedMap()
        {
            // Primary Key
            this.HasKey(t => t.cost_tran_sched_id);
            ...
            this.ToTable("cost_tran_sched", "afm");
            ...
            this.HasOptional(t => t.afm_currencies1)
                .WithMany(t => t.cost_tran_sched1)
                .HasForeignKey(d => d.currency_payment);
            this.HasOptional(t => t.bl)
                .WithMany(t => t.cost_tran_sched)
                .HasForeignKey(d => d.bl_id);
            this.HasOptional(t => t.contact)
                .WithMany(t => t.CostTranSched)
                .HasForeignKey(d => d.tax_authority_contact);
