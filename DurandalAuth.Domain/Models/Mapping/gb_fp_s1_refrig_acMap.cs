...
{
    public class gb_fp_s1_refrig_acMap : EntityTypeConfiguration<gb_fp_s1_refrig_ac>
    {
        public gb_fp_s1_refrig_acMap()
        {
            // Primary Key
            ...
            this.Property(t => t.refrigerant_type)
                .IsRequired()
                .IsFixedLength()
                .HasMaxLength(50);
            ...
            this.HasRequired(t => t.gb_fp_setup)
                .WithMany(t => t.gb_fp_s1_refrig_ac)
