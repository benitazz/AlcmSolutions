...
{
    public class rrmonusearrMap : EntityTypeConfiguration<rrmonusearr>
    {
        public rrmonusearrMap()
        {
            // Primary Key
            this.HasKey(t => new { t.bl_id, t.fl_id, t.rm_id, t.date_start, t.time_start, t.time_end, t.rm_arrange_type_id, t.config_id });
