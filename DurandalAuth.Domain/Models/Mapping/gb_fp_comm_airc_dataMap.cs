...
{
    public class gb_fp_comm_airc_dataMap : EntityTypeConfiguration<gb_fp_comm_airc_data>
    {
        public gb_fp_comm_airc_dataMap()
        {
            // Primary Key
            this.HasKey(t => new { t.version_type, t.version_name, t.seating_type, t.distance_type });
            ...
            this.ToTable("gb_fp_comm_airc_data", "afm");
            ...
            this.HasRequired(t => t.bill_type)
                .WithMany(t => t.gb_fp_comm_airc_data)
                .HasForeignKey(d => d.ch4_n2o_units_type);
            this.HasRequired(t => t.bill_type1)
                .WithMany(t => t.gb_fp_comm_airc_data1)
