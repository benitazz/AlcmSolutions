...
namespace DurandalAuth.Domain.Models.Mapping
{
    public class activity_logviewMap : EntityTypeConfiguration<activity_logview>
    {
        public activity_logviewMap()
        {
            ...
            this.ToTable("activity_logview", "afm");
