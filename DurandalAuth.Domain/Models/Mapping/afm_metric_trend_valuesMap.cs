...
{
    public class afm_metric_trend_valuesMap : EntityTypeConfiguration<afm_metric_trend_values>
    {
        public afm_metric_trend_valuesMap()
        {
            // Primary Key
            ...
            this.ToTable("afm_metric_trend_values", "afm");
            ...
            this.HasRequired(t => t.afm_metric_definitions)
                .WithMany(t => t.afm_metric_trend_values)
                .HasForeignKey(d => d.metric_name);
            this.HasOptional(t => t.afm_metric_gran_defs)
                .WithMany(t => t.afm_metric_trend_values)
