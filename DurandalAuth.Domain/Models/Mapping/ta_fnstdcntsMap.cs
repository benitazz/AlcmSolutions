...
{
    public class ta_fnstdcntsMap : EntityTypeConfiguration<ta_fnstdcnts>
    {
        public ta_fnstdcntsMap()
        {
            // Primary Key
