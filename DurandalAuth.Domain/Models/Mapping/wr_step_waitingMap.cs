...
{
    public class wr_step_waitingMap : EntityTypeConfiguration<wr_step_waiting>
    {
        public wr_step_waitingMap()
        {
            // Primary Key
            this.HasKey(t => new { t.wr_id, t.date_created, t.time_created, t.status, t.step, t.step_type, t.step_log_id, t.activity_id });
            ...
            this.ToTable("wr_step_waiting", "afm");
