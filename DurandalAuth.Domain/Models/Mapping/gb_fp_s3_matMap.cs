...
{
    public class gb_fp_s3_matMap : EntityTypeConfiguration<gb_fp_s3_mat>
    {
        public gb_fp_s3_matMap()
        {
            // Primary Key
            ...
            this.ToTable("gb_fp_s3_mat", "afm");
            this.Property(t => t.amount_purchased).HasColumnName("amount_purchased");
            this.Property(t => t.amount_purchased_entry).HasColumnName("amount_purchased_entry");
            this.Property(t => t.bl_id).HasColumnName("bl_id");
            this.Property(t => t.calc_year).HasColumnName("calc_year");
            this.Property(t => t.kg_co2).HasColumnName("kg_co2");
            this.Property(t => t.recycled_content).HasColumnName("recycled_content");
