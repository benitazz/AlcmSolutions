...
{
    public class woMap : EntityTypeConfiguration<wo>
    {
        public woMap()
        {
            // Primary Key
            this.HasKey(t => t.wo_id);
            ...
            this.HasOptional(t => t.em)
                .WithMany(t => t.woes)
                .HasForeignKey(d => d.name_authorized);
            this.HasOptional(t => t.em1)
                .WithMany(t => t.woes1)
                .HasForeignKey(d => d.name_of_contact);
            this.HasOptional(t => t.em2)
                .WithMany(t => t.woes2)
                .HasForeignKey(d => d.name_of_planner);
