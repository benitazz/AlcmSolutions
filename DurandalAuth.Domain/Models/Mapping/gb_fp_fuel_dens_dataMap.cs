...
{
    public class gb_fp_fuel_dens_dataMap : EntityTypeConfiguration<gb_fp_fuel_dens_data>
    {
        public gb_fp_fuel_dens_dataMap()
        {
            // Primary Key
            ...
            this.ToTable("gb_fp_fuel_dens_data", "afm");
            this.Property(t => t.fuel_density).HasColumnName("fuel_density");
            this.Property(t => t.fuel_density_entry).HasColumnName("fuel_density_entry");
            ...
            this.HasRequired(t => t.bill_type)
                .WithMany(t => t.gb_fp_fuel_dens_data)
