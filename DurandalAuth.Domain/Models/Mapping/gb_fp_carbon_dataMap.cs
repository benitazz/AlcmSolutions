...
{
    public class gb_fp_carbon_dataMap : EntityTypeConfiguration<gb_fp_carbon_data>
    {
        public gb_fp_carbon_dataMap()
        {
            // Primary Key
            ...
            this.ToTable("gb_fp_carbon_data", "afm");
            ...
            this.HasRequired(t => t.bill_type)
                .WithMany(t => t.gb_fp_carbon_data)
